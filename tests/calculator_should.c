...
START_TEST(minuend_same_as_subtrahend_fails_no_zeros_in_roman) {
    char roman_total[MAX_ROMAN_NUMERAL_STRING_SIZE] = {'\0'};
    ck_assert_int_eq(EXIT_FAILURE, subtract(roman_total, "I", "I"));
} END_TEST
...
Suite * calculator_suite(void) {
    ...
    tcase_add_test(tc_core, minuend_same_as_subtrahend_fails_no_zeros_in_roman);
